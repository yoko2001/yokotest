...
echo 0 > /sys/kernel/debug/tracing/events/lru_gen/folio_ws_chg/enable
echo 0 > /sys/kernel/debug/tracing/events/lru_gen/folio_ws_chg_se/enable
...
echo 0 > /sys/kernel/debug/tracing/events/swap/should_try_to_free_swap/enable
